...
<meta http-equiv="refresh" content="5;url=https://cms-analysis-corrections.docs.cern.ch/">
</head>
<body>
<p>You will be redirected in a few seconds. If not, <a href="https://cms-analysis-corrections.docs.cern.ch/">click here</a>.</p>
</body>
</html>
        """
    )
